 ...
 * @returns {History}
 */
const getHistory = (contextId: string) => histories.get(contextId) || new History();
 ...
 * @returns {History}
 */
const setHistory = (contextId: string, history: History) => histories.set(contextId, history);

/**
 * @param {string} contextId
 * @param {function(History)} callback
 */
const updateHistory = (contextId: string, callback: (history: History) => History | void) => {
