const zh = {
  ...
  __COMMAND_SYS_REPORT_REPLY: '請留下您的問題，謝謝。',
  __COMMAND_SYS_REPORT_FINISH_LABEL: '已回報問題',
  __COMMAND_SYS_REPORT_FINISH_TEXT: '已回報問題',
  ...
  __ERROR_SYSTEM_UNSTABLE: 'AI系統繁忙中，請稍後再試',
